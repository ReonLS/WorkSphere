<%@ Page Title="" Language="C#" MasterPageFile="~/Navbar.Master" AutoEventWireup="true" CodeBehind="Community.aspx.cs" Inherits="Worksphere.Views.Applicant.Community" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="body">
        ...
        <div class="right">
            <%-- Ngambil nama user dari backend --%>
            <%--<h2>Hello, <span><%= %></span></h2>--%>
            <div class="hello">
                <h2>Hello, <span>Budi</span></h2>
            ...
            <div class="right-container">
                ...
                <%-- ini nnti pake foreach aja sesuai sm brp feeds yang ada --%>
                <%for (var i=1; i<=8; i++) { %>
                    <div class="feeds">
                        <div class="feeds-container">
                            ...
                            <div class="content">
                                <p>
                                    ...
                                    mi imperdiet sit. Lectus eleifend aliquam nibh mauris, pretium. Lectus magnis lorem massa 
                                    urna felis porta.
                                </p>
                            </div>
                         </div>
